...
const (
	...
	BankService_CreateExchangeRate_FullMethodName    = "/bank.BankService/CreateExchangeRate"
...
type BankServiceClient interface {
	...
	FetchExchangeRate(ctx context.Context, in *ExchangeRateRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExchangeRateResponse], error)
	SummarizeTransactions(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[TransactionRequest, TransactionSummaryResponse], error)
}
...
func (c *bankServiceClient) CreateExchangeRate(ctx context.Context, in *CreateExchangeRateRequest, opts ...grpc.CallOption) (*CreateExchangeRateResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateExchangeRateResponse)
	err := c.cc.Invoke(ctx, BankService_CreateExchangeRate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bankServiceClient) FetchExchangeRate(ctx context.Context, in *ExchangeRateRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExchangeRateResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &BankService_ServiceDesc.Streams[0], BankService_FetchExchangeRate_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
type BankService_FetchExchangeRateClient = grpc.ServerStreamingClient[ExchangeRateResponse]

func (c *bankServiceClient) SummarizeTransactions(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[TransactionRequest, TransactionSummaryResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &BankService_ServiceDesc.Streams[1], BankService_SummarizeTransactions_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[TransactionRequest, TransactionSummaryResponse]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type BankService_SummarizeTransactionsClient = grpc.ClientStreamingClient[TransactionRequest, TransactionSummaryResponse]
...
type BankServiceServer interface {
	...
	FetchExchangeRate(*ExchangeRateRequest, grpc.ServerStreamingServer[ExchangeRateResponse]) error
	SummarizeTransactions(grpc.ClientStreamingServer[TransactionRequest, TransactionSummaryResponse]) error
...
func (UnimplementedBankServiceServer) CreateExchangeRate(context.Context, *CreateExchangeRateRequest) (*CreateExchangeRateResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateExchangeRate not implemented")
}
func (UnimplementedBankServiceServer) FetchExchangeRate(*ExchangeRateRequest, grpc.ServerStreamingServer[ExchangeRateResponse]) error {
	return status.Errorf(codes.Unimplemented, "method FetchExchangeRate not implemented")
}
func (UnimplementedBankServiceServer) SummarizeTransactions(grpc.ClientStreamingServer[TransactionRequest, TransactionSummaryResponse]) error {
...
func _BankService_CreateExchangeRate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateExchangeRateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BankServiceServer).CreateExchangeRate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BankService_CreateExchangeRate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BankServiceServer).CreateExchangeRate(ctx, req.(*CreateExchangeRateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _BankService_FetchExchangeRate_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(BankServiceServer).FetchExchangeRate(m, &grpc.GenericServerStream[ExchangeRateRequest, ExchangeRateResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type BankService_FetchExchangeRateServer = grpc.ServerStreamingServer[ExchangeRateResponse]

func _BankService_SummarizeTransactions_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(BankServiceServer).SummarizeTransactions(&grpc.GenericServerStream[TransactionRequest, TransactionSummaryResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type BankService_SummarizeTransactionsServer = grpc.ClientStreamingServer[TransactionRequest, TransactionSummaryResponse]
...
var BankService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _BankService_CreateExchangeRate_Handler,
		},
	},
